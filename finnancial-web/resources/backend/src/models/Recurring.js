...
async function findById(id) { 
  ...
  return await prisma.recurring_transactions.findUnique({ where: { id } });
}
...
async function create(data) {
  return await prisma.recurring_transactions.create({
    data: {
      user_id: data.userId,
 ...
 */
async function updateNextDueDate(id, nextDueDate) {
...
async function remove(id) { 
  ...
  await prisma.recurring_transactions.delete({ where: { id } });
}
