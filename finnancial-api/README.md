# Finnancial - API de Gestão Financeira

Backend RESTful de alto desempenho para o sistema Finnancial, construído com Node.js, Express e Prisma ORM.
