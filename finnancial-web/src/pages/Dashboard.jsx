...
import { ArrowUpCircle, ArrowDownCircle, Wallet, PiggyBank, ArrowUpRight, ArrowDownRight, Bell, RefreshCw } from 'lucide-react';
...
function SummaryCard({ label, value, isPercent, vDelta, inverted }) {
  ...
  return (
    <div className={styles.summaryCard}>
      ...
      <span className={styles.summaryValue}>{isPercent ? `${value}%` : formatCurrency(value)}</span>
