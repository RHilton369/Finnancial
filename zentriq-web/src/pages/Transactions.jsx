...
export default function Transactions() {
  ...
  const handleImport = async (transactionsToImport) => {
    try {
      await transactionsApi.createBulk(transactionsToImport);
    ...
    <div className={styles.container}>
      ...
      <div className={styles.header}>
        ...
        <div style={{ display: 'flex', gap: '12px' }}>
          <button className={styles.addButton} style={{ background: 'var(--bg-secondary)', color: 'var(--text-primary)' }} onClick={() => setImportOpen(true)}>
                    ...
                    <div className={styles.txRight}>
                      ...
                      <div className={styles.txActions}>
                        ...
                        <button 
                          ...
                          onClick={() => { setDeleteId(tx.id); setConfirmOpen(true); }}
